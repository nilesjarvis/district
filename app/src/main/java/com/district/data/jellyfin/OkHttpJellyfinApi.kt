...
import com.district.domain.AuthHeaders
...
class OkHttpJellyfinApi(
    ...
    override suspend fun search(session: AuthSession, query: String): SearchResults = withContext(dispatchers.io) {
        ...
        val albums = mutableListOf<com.district.domain.Album>()
        val tracks = mutableListOf<com.district.domain.Track>()
        val artists = mutableListOf<com.district.domain.Artist>()
    ...
    private fun authorizationHeader(deviceId: String, token: String?): String =
        buildString {
            append("MediaBrowser Client=\"District\", Device=\"Android\", ")
